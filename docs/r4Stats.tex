...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sort}\NormalTok{(wts}\SpecialCharTok{$}\NormalTok{weight, }\AttributeTok{decreasing =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(wts}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{var}\NormalTok{(wts}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{z\_score}\NormalTok{(wts}\SpecialCharTok{$}\NormalTok{weight)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x }\OtherTok{\textless{}{-}}\NormalTok{ babies}\SpecialCharTok{$}\NormalTok{smoke}
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(x, }\AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\StringTok{"never"}\NormalTok{, }\StringTok{"now"}\NormalTok{, }\StringTok{"until current"}\NormalTok{, }\StringTok{"once, quit"}\NormalTok{, }\StringTok{"unknown"}\NormalTok{ ))}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(fat}\SpecialCharTok{$}\NormalTok{wrist, fat}\SpecialCharTok{$}\NormalTok{neck)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-46-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x }\OtherTok{\textless{}{-}}\NormalTok{ fat}\SpecialCharTok{$}\NormalTok{wrist[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{20}\NormalTok{]; y }\OtherTok{\textless{}{-}}\NormalTok{ fat}\SpecialCharTok{$}\NormalTok{neck[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{20}\NormalTok{]                      }\CommentTok{\# data}
\FunctionTok{plot}\NormalTok{(x, y, }\AttributeTok{main =} \StringTok{"Neck by Wrist"}\NormalTok{)            }
\FunctionTok{abline}\NormalTok{(}\AttributeTok{v =} \FunctionTok{mean}\NormalTok{(x), }\AttributeTok{lty=}\DecValTok{2}\NormalTok{)                                     }\CommentTok{\# dashed vertical line}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h =} \FunctionTok{mean}\NormalTok{(y), }\AttributeTok{lty=}\DecValTok{2}\NormalTok{)                                     }\CommentTok{\# dashed horizontal line}
\FunctionTok{points}\NormalTok{(}\FunctionTok{mean}\NormalTok{(x), }\FunctionTok{mean}\NormalTok{(y), }\AttributeTok{pch=}\DecValTok{16}\NormalTok{, }\AttributeTok{cex=}\DecValTok{4}\NormalTok{, }\AttributeTok{col=}\FunctionTok{rgb}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{, .}\DecValTok{25}\NormalTok{))  }
\end{Highlighting}
\end{Shaded}

\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(fat}\SpecialCharTok{$}\NormalTok{wrist, fat}\SpecialCharTok{$}\NormalTok{neck)    }\CommentTok{\# strongly correlated}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(fat}\SpecialCharTok{$}\NormalTok{wrist, fat}\SpecialCharTok{$}\NormalTok{height)  }\CommentTok{\# mildly correlated}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(fat}\SpecialCharTok{$}\NormalTok{age, fat}\SpecialCharTok{$}\NormalTok{ankle)     }\CommentTok{\# basically uncorrelated}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(Animals}\SpecialCharTok{$}\NormalTok{body, Animals}\SpecialCharTok{$}\NormalTok{brain)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Animals}\SpecialCharTok{$}\NormalTok{body, Animals}\SpecialCharTok{$}\NormalTok{brain)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-50-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{body }\OtherTok{\textless{}{-}}\NormalTok{ Animals}\SpecialCharTok{$}\NormalTok{body; brain }\OtherTok{\textless{}{-}}\NormalTok{ Animals}\SpecialCharTok{$}\NormalTok{brain}
\NormalTok{cross\_prods }\OtherTok{\textless{}{-}}\NormalTok{ (body }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(body)) }\SpecialCharTok{*}\NormalTok{ (brain }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(brain))}
\NormalTok{Animals[cross\_prods }\SpecialCharTok{\textless{}} \DecValTok{0}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(ToothGrowth}\SpecialCharTok{$}\NormalTok{dose, ToothGrowth}\SpecialCharTok{$}\NormalTok{len)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{l }\OtherTok{\textless{}{-}} \FunctionTok{split}\NormalTok{(ToothGrowth}\SpecialCharTok{$}\NormalTok{len, ToothGrowth}\SpecialCharTok{$}\NormalTok{dose)}
\NormalTok{group\_means }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{mean}\NormalTok{(l[[}\DecValTok{1}\NormalTok{]]), }\FunctionTok{mean}\NormalTok{(l[[}\DecValTok{2}\NormalTok{]]), }\FunctionTok{mean}\NormalTok{(l[[}\DecValTok{3}\NormalTok{]]))}
\FunctionTok{cor}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{), group\_means)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(SAT}\SpecialCharTok{$}\NormalTok{salary, SAT}\SpecialCharTok{$}\NormalTok{total)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(SAT}\SpecialCharTok{$}\NormalTok{salary, SAT}\SpecialCharTok{$}\NormalTok{total)}
\end{Highlighting}
\end{Shaded}

\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-57-1.pdf}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-58-1.pdf}
- shows correlation for each subgroup is positive

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{total }\OtherTok{\textless{}{-}}\NormalTok{ SAT}\SpecialCharTok{$}\NormalTok{total; salary }\OtherTok{\textless{}{-}}\NormalTok{ SAT}\SpecialCharTok{$}\NormalTok{salary; perc }\OtherTok{\textless{}{-}}\NormalTok{ SAT}\SpecialCharTok{$}\NormalTok{perc}
\NormalTok{less\_10 }\OtherTok{\textless{}{-}}\NormalTok{ perc }\SpecialCharTok{\textless{}} \DecValTok{10}
\NormalTok{more\_40 }\OtherTok{\textless{}{-}}\NormalTok{ perc }\SpecialCharTok{\textgreater{}} \DecValTok{40}
\NormalTok{between }\OtherTok{\textless{}{-}} \SpecialCharTok{!}\NormalTok{less\_10 }\SpecialCharTok{\&} \SpecialCharTok{!}\NormalTok{more\_40}
\FunctionTok{c}\NormalTok{(}\AttributeTok{less =} \FunctionTok{cor}\NormalTok{(total[less\_10], salary[less\_10]),}
  \AttributeTok{between =} \FunctionTok{cor}\NormalTok{(total[between], salary[between]),}
  \AttributeTok{more =} \FunctionTok{cor}\NormalTok{(total[more\_40], salary[more\_40]))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-60-1.pdf}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-62-1.pdf}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-81-1.pdf}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-82-1.pdf}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-83-1.pdf}
...
\includegraphics{r4Stats_files/figure-latex/unnamed-chunk-84-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{survived }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(titanic}\SpecialCharTok{$}\NormalTok{Survived, titanic}\SpecialCharTok{$}\NormalTok{Freq)}
\NormalTok{survivied }\OtherTok{\textless{}{-}} \FunctionTok{ordered}\NormalTok{(survived)}
\NormalTok{class }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(titanic}\SpecialCharTok{$}\NormalTok{Class, titanic}\SpecialCharTok{$}\NormalTok{Freq)}
\NormalTok{class }\OtherTok{\textless{}{-}} \FunctionTok{ordered}\NormalTok{(class)}
\FunctionTok{head}\NormalTok{(class)}
\end{Highlighting}
\end{Shaded}
